...
MERGE INTO `jws_permission`(id, permission_code, permission_name, permission_url) VALUES ('1', 'insert_user', '新增用户', '/user/add'); -- REPLACE INTO
MERGE INTO `jws_permission`(id, permission_code, permission_name, permission_url) VALUES ('2', 'delete_user', '删除用户', '/user/remove'); -- REPLACE INTO
MERGE INTO `jws_permission`(id, permission_code, permission_name, permission_url) VALUES ('3', 'update_user', '更新用户', '/user/edit'); -- REPLACE INTO
MERGE INTO `jws_permission`(id, permission_code, permission_name, permission_url) VALUES ('4', 'select_one_user', '查询单个用户', '/user/get'); -- REPLACE INTO
MERGE INTO `jws_permission`(id, permission_code, permission_name, permission_url) VALUES ('5', 'select_all_user', '查询全部用户', '/user/list'); -- REPLACE INTO
