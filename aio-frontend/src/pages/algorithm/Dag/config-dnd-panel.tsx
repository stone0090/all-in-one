...
import {delay} from "@/pages/algorithm/Dag/config-form";
...
const NodeDescription = (props: { operator: any }) => {
  return (
    <Card size="small" title={props.operator.opName} style={{width: '300px'}} bordered={false}>
      算子入参：
...
export const nodeDataService: NsNodeCollapsePanel.INodeDataService = async (graphMeta, modelService) => {
  ...
  console.log("nodeDataService", graphMeta, modelService, flowId, experiment, opGroups)
